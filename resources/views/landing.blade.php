...
@section('content')
    ...
    <section class="landing-hero relative py-20 md:py-28 px-4 overflow-hidden">
        ...
        <div class="container mx-auto max-w-6xl text-center relative">
            <h1 class="text-3xl md:text-5xl font-bold text-slate-800 mb-8 leading-snug">
                نوفر
                <span class="text-teal-700">حلولاً تسويقية رقمية شاملة</span>
            </h1>
            ...
            <p class="text-base md:text-lg text-slate-500 max-w-2xl mx-auto leading-relaxed">
                الفكرة الأساسية عندنا: <strong class="text-slate-700">الإبداع والتميز</strong>، واستخدام أدوات <strong class="text-teal-700">الذكاء الاصطناعي</strong> للوصول إلى أكبر عدد من العملاء.
            </p>
        </div>
    </section>
    ...
    <section class="landing-services py-20 md:py-28 px-4">
        <div class="container mx-auto max-w-6xl">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                {{-- 1. محتوى مرئي --}}
                <div class="landing-service-card p-8 rounded-2xl bg-white border border-slate-200 border-t-4 border-t-teal-500 hover:border-teal-400 hover:shadow-xl transition-all duration-300">
    ...
    <section class="landing-cta py-20 md:py-28 px-4 bg-white border-t-4 border-teal-100">
...
.landing-hero { position: relative; background: linear-gradient(160deg, #f0fdfa 0%, #ccfbf1 45%, #99f6e4 100%); }
.landing-hero-bg {
    position: absolute; inset: 0; overflow: hidden; pointer-events: none;
    background: radial-gradient(ellipse 80% 50% at 70% 20%, rgba(13, 148, 136, 0.10) 0%, transparent 50%),
                radial-gradient(ellipse 60% 40% at 20% 80%, rgba(20, 184, 166, 0.08) 0%, transparent 50%);
}
/* Services section: subtle alternate background */
.landing-services { background: linear-gradient(180deg, #ecfdf5 0%, #f0fdfa 100%); }
/* Cards: icon size + hover */
.landing-service-icon svg { width: 4rem; height: 4rem; color: rgb(13 148 136); transition: color 0.2s ease, transform 0.2s ease; }
.landing-service-card:hover .landing-service-icon svg { color: rgb(15 118 110); transform: scale(1.08); }
</style>
@endpush
