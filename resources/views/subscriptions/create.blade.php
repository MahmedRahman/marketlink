...
@section('page-title', 'إضافة اشتراك جديد')
        ...
        <form action="{{ route('subscriptions.store') }}" method="POST" class="subscription-form">
            ...
            <div class="form-group">
                ...
                <div class="login-type-cards">
                    <input type="radio" name="login_type" id="user_pass" value="user_pass" class="login-type-input" {{ old('login_type', 'user_pass') === 'user_pass' ? 'checked' : '' }} required onchange="toggleLoginFields()">
                    <label for="user_pass" class="login-type-card">
                        <div class="card-icon">🔑</div>
                        <div class="card-title">يوزر وباسورد</div>
                    </label>

                    <input type="radio" name="login_type" id="gmail" value="gmail" class="login-type-input" {{ old('login_type') === 'gmail' ? 'checked' : '' }} onchange="toggleLoginFields()">
            ...
            <div class="form-group">
                ...
                <div class="ownership-type-cards">
                    <input type="radio" name="subscription_ownership" id="official" value="official" class="ownership-type-input" {{ old('subscription_ownership', 'official') === 'official' ? 'checked' : '' }} required onchange="toggleSharedPhone()">
                    <label for="official" class="ownership-type-card">
                        <div class="card-icon">✅</div>
                        <div class="card-title">اشتراك رسمي</div>
                    </label>

                    <input type="radio" name="subscription_ownership" id="shared" value="shared" class="ownership-type-input" {{ old('subscription_ownership') === 'shared' ? 'checked' : '' }} onchange="toggleSharedPhone()">
            ...
            <div class="form-group">
                ...
                <div class="subscription-type-cards">
                    <input type="radio" name="subscription_type" id="monthly" value="monthly" class="subscription-type-input" {{ old('subscription_type', 'monthly') === 'monthly' ? 'checked' : '' }} required onchange="toggleRenewalDay()">
                    <label for="monthly" class="subscription-type-card">
                        <div class="card-icon">📅</div>
                        <div class="card-title">شهري</div>
                    </label>

                    <input type="radio" name="subscription_type" id="yearly" value="yearly" class="subscription-type-input" {{ old('subscription_type') === 'yearly' ? 'checked' : '' }} onchange="toggleRenewalDay()">
            ...
            <div class="form-group" id="renewal-day-group" style="display: {{ old('subscription_type', 'monthly') === 'monthly' ? 'flex' : 'none' }};">
                <label for="renewal_day">يوم التجديد <span class="required" id="renewal-day-required">*</span></label>
                <input 
                    type="number" 
                    id="renewal_day" 
                    name="renewal_day" 
                    value="{{ old('renewal_day') }}" 
                    min="1"
                    max="31"
            ...
            <div class="form-group">
                ...
                <div class="currency-type-cards">
                    <input type="radio" name="currency" id="egp" value="egp" class="currency-type-input" {{ old('currency', 'egp') === 'egp' ? 'checked' : '' }} required>
                    <label for="egp" class="currency-type-card">
                        <div class="card-icon">🇪🇬</div>
                        <div class="card-title">جنيه مصري</div>
                    </label>

                    <input type="radio" name="currency" id="usd" value="usd" class="currency-type-input" {{ old('currency') === 'usd' ? 'checked' : '' }}>
